...
p5.prototype.createMomentary = function(x_, y_, width_, height_, label_, callback_) {
  let m_ = new MomentaryButton(x_, y_, width_, height_, label_, callback_);
  return m_;
}

p5.prototype.createToggle = function(x_, y_, width_, height_, label_, callbackOn_, callbackOff_) {
  let t_ = new ToggleButton(x_, y_, width_, height_, label_, callbackOn_, callbackOff_);
  return t_;
}
...
function ToggleButton (x_, y_, width_, height_, label_, callbackOn_, callbackOff_){
  ...
  this.setCallbackOff = function(callbackOff_) {
    this.callbackOff = callbackOff_;
