...
class GuiContext {
  ...
  // TODO: Debug this implementation. Not loading text size properly.
  ...
  drawState(fillBg, fillTrack, fillHandle, strokeBg, strokeTrack, strokeHandle) {
    ...
    push();
      ...
      push();
        stroke(strokeTrack);
        fill(fillTrack);
        rect(this.x+trackMarginX, this.y+trackMarginY, xpos-trackMarginX, this.h-trackMarginY*2, 
  ...
  drawState(fillBg, fillTrack, fillHandle, strokeBg, strokeTrack, strokeHandle) {
    ...
    push();
      ...
      push();
        stroke(strokeTrack);
        fill(fillTrack);
        rect(this.x+trackMarginX, this.y+ypos, 
             this.w-trackMarginX*2, this.h-ypos-trackMarginY, 
